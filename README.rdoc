...
from any previous version to version 2.1.0

In your deploy.rb change 
...
== Usage
  ...
  3. Add a cap_mailer_settings.rb file to your config/ directory:
    ...
    CapMailer.recipient_addresses = ["dev1@example.com"]
    CapMailer.sender_address = %("Capistrano Deployment" <releases@default.com>)
    CapMailer.email_prefix = "[EXAMPLE-CAP-DEPLOY]"
    CapMailer.site_name = "Example.com"
