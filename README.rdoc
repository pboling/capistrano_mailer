= Capistrano Mailer v3.0.0 (20090919)
...
Gem Using Git building from source:
  ...
  sudo gem install capistrano_mailer-3.0.0.gem # (Or whatever version gets built)
...
From version 2.1.0 to version 3.0.0:
...
== Usage
  ...
  2. Add this line to the top of your deploy.rb:
    ...
    # For plugin:
    require 'vendor/plugins/capistrano_mailer/lib/capistrano/mailer'
...
----------------------------------------------------------------------------------
  ...
  Copyright (c) 2007 Peter Boling under MIT License
